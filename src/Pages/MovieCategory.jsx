...
import { getMoviesByCategory } from '../Services/MovieServices';
...
const MovieCategory = () => {
    ...
    handleLoadMore.current = async () => {
        setLoading(true);
        try {
            const loadedMovies = await getMoviesByCategory(slug, nextPage);
            // Kiểm tra dữ liệu trùng lặp
            const uniqueMovies = filterUniqueMovies([...movies, ...loadedMovies.items]);
