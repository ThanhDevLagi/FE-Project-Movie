...
const UserDropdown = ({ user, logout }) => {
    ...
    return (
        <div className="relative z-40" ref={nodeRef}>
            <button
            ...
            {show && (
                <div className="absolute top-full right-1/3 transform mt-2 w-72 popup-zoom bg-white rounded-lg shadow-lg border border-gray-200 z-30">
                    <div className="p-4">
